...
const OwnerInvoices = () => {
  ...
  const { data, isLoading } = useCustomQuery({
    queryKey: ["owner-invoices", JSON.stringify(filters)],
    url: `owners/invoices/${queryParams.toString() ? `?${queryParams.toString()}` : ""}`,
  });
      ...
      <div className="bg-white rounded-lg shadow-sm">
        ...
        <div className="p-6">
          <InvoicesTable 
            ...
            selectedInvoices={[]} // No selection allowed for owners
            onInvoiceSelection={() => {}} // No selection allowed for owners
            showSelection={false} // Disable selection for owner view
          />
        </div>
      </div>
    </div>
