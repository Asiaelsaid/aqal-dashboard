...
const PropertyAccordion = ({ property }: { property: Property }) => {
  ...
  return (
    <div className="mb-6">
      <div
        className="p-5 bg-gray-100 hover:bg-gray-200 cursor-pointer rounded-lg shadow-md transition-colors"
      ...
      >
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600">{property.total_units} units</p>
          </div>
